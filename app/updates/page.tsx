...
const lectures = [
  ...
  },
  {
    ...
    status: 'Upcoming',
    description:
      'Sensor input, actuator output, motor control, pump control, and real-world robotics sensing applications will be updated after class.',
  },
  {
    id: 5,
    date: '2026-06-17',
    ...
    time: 'Wednesday • 6:30 PM - 9:30 PM',
    title: 'Mobile Robot Movement',
    status: 'Upcoming',
    description:
      'Rover chassis movement, motor driver usage, wheel control, and basic navigation concepts will be updated after class.',
  },
  {
    id: 6,
    date: '2026-06-24',
    ...
    time: 'Wednesday • 6:30 PM - 9:30 PM',
    title: 'Obstacle Detection & Navigation',
    status: 'Upcoming',
    description:
      'Obstacle detection using ultrasonic sensors, safe movement logic, and autonomous navigation will be updated after class.',
  },
  {
    id: 7,
    date: '2026-07-01',
    ...
    status: 'Upcoming',
    description:
      'Microcontroller-based robotics, ESP32 programming, sensor reading, and decision logic will be updated after class.',
  },
  {
    id: 8,
    date: '2026-07-08',
    ...
    time: 'Wednesday • 6:30 PM - 9:30 PM',
    title: 'IoT Monitoring for Smart Systems',
    status: 'Upcoming',
    description:
      'IoT dashboard, real-time monitoring, sensor data visualization, and remote irrigation status will be updated after class.',
  },
  {
    id: 9,
    date: '2026-07-15',
    ...
    status: 'Upcoming',
    description:
      'Soil moisture threshold, adaptive watering, pump activation, and precision irrigation logic will be updated after class.',
  },
  {
    id: 10,
    date: '2026-07-22',
    ...
    status: 'Upcoming',
    description:
      'Combining sensors, motors, pump, relay, ESP32, and IoT monitoring into one working rover system will be updated after class.',
  },
  {
    id: 11,
    date: '2026-07-29',
    ...
    status: 'Upcoming',
    description:
      'Sensor calibration, movement testing, pump testing, and field trial preparation will be updated after class.',
  },
  {
    id: 12,
    date: '2026-08-05',
    ...
    status: 'Upcoming',
    description:
      'Review of project implementation, website, documentation, and demonstration plan will be updated after class.',
  },
  {
    id: 13,
    date: '2026-08-12',
    ...
    status: 'Upcoming',
    description:
      'Final project preparation, presentation practice, demonstration setup, and final submission checking will be updated after class.',
  },
];
