...
export const lectures: Lecture[] = [
  ...
  },
  {
    ...
    time: "Wednesday • 6:30 PM – 9:30 PM",
    title: "Briefing for the Final Project",
    status: "Completed",
    description: "Details about how we will submit our final project and assignment. We also discussed about the different types of projects that can be submitted and how to prepare for them.",
  },
  {
    id: 11,
    date: "2026-07-22",
    ...
    time: "Wednesday • 6:30 PM – 9:30 PM",
    title: "Due to sir abroad travel, the class was closed",
    status: "Closed",
    description: "",
  },
  {
  ...
  },
  {
    ...
    title: "Final Exam",
    status: "Completed",
    description: "Final Exam- The final exam was conducted on 12th August 2026. The exam was based on the topics covered in the previous classes. The students were given 1 hour to complete the exam.",
  },
];
